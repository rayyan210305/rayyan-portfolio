        ...
        >
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full border border-accent/30 text-white hover:bg-accent/10 hover:border-accent/50 transition-all duration-300 mb-10"
            >
              <span className="font-mono text-sm">
                rayyanmardhatillah21@gmail.com
              </span>
            </a>
          </motion.div>
