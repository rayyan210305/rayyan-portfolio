...
const featuredProject = {
  ...
  images: [
    { src: "/projects/lp3-login-hq.png", alt: "Halaman Login Admin — autentikasi PIN untuk akses sistem" },
    { src: "/projects/lp3-dashboard-hq.png", alt: "Dashboard LP3 — statistik kehadiran & scan log" },
    { src: "/projects/lp3-scanner-hq.png", alt: "Halaman scanner absensi QR/Barcode" },
    { src: "/projects/lp3-participants-hq.png", alt: "Data peserta LP3 Putra XVII" },
    { src: "/projects/lp3-attendance-hq.png", alt: "Histori absensi real-time" },
  ],
